...
import root.NavigationButtons;
import root.PageNavigatorPool;
...
public class testPoolMandatory extends StartPool {
...
//страница 2
        ...
        Assert.assertEquals(mandatoryField2.size(), 1, "Нет предупреждения об обязательности вопроса Дихотомия 5 ответов!");
...
//страница 3
        ...
        //если надпись есть, то выбираем ответ и переходим к следующему вопросу
        Assert.assertEquals(mandatoryField3.size(), 1, "Нет предупреждения об обязательности вопроса Дихотомия 7 вариантов ответа!");
...
//завершающая страница
        ...
        System.out.println("проверка обязательности вопроса - пройден");
    }
}
